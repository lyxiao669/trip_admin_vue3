    ...
    <el-table :data="users">
      ...
      <el-table-column label="操作" width="400">
        <template v-slot="{ row }">
          ...
          <el-button size="mini" type="info" icon="el-icon-office-building" @click="updRole(row)">改部门</el-button>
          <el-button size="mini" type="success" icon="el-icon-edit" @click="updAccount(row)">编辑</el-button>
          <el-button size="mini" type="danger" icon="el-icon-delete" @click="delAccount(row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
